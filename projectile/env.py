...
EMAIL_VERIFICATION_TIMEOUT = int(os.getenv('EMAIL_VERIFICATION_TIMEOUT') or 86400)
...
FRONTEND_CHECKOUT_SUCCESS_URL = os.getenv('FRONTEND_CHECKOUT_SUCCESS_URL')
FRONTEND_CHECKOUT_CANCEL_URL = os.getenv('FRONTEND_CHECKOUT_CANCEL_URL')
