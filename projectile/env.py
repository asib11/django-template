...
CHANNEL_LAYERS_DEFAULT_HOST = os.getenv('CHANNEL_LAYERS_DEFAULT_HOST') or 'localhost'
CHANNEL_LAYERS_DEFAULT_PORT = int(os.getenv('CHANNEL_LAYERS_DEFAULT_PORT') or 6379)
